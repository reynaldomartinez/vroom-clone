...
<div>
  ...
  <div className={isOpen ? 'inset-1 flex z-40 absolute top-14 left-0' : 'hidden'}>
    <div role="dialog" aria-modal="true">
      <div className="fixed inset-0 bg-black bg-opacity-25" aria-hidden="true"></div>
      <div className="ml-auto relative -top-14  max-w-xs w-full bg-white shadow-xl py-4 pb-12 flex flex-col overflow-y-auto">
            ...
            <div className="pt-6" id="filter-section-mobile-0">
              <div className="space-y-6">
                <div className="flex items-center">
                  ...
                  <label for="filter-mobile-color-4" className="ml-3 min-w-0 flex-1 text-gray-500"> Acura </label>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <label for="filter-mobile-color-0" className="ml-3 min-w-0 flex-1 text-gray-500"> BMW </label>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <label for="filter-mobile-color-1" className="ml-3 min-w-0 flex-1 text-gray-500"> Dodge </label>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <label for="filter-mobile-color-2" className="ml-3 min-w-0 flex-1 text-gray-500"> Ford </label>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <label for="filter-mobile-color-3" className="ml-3 min-w-0 flex-1 text-gray-500"> Nissan </label>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <label for="filter-mobile-color-5" className="ml-3 min-w-0 flex-1 text-gray-500"> Toyota </label>
                </div>
              </div>
            </div>
          </div>
